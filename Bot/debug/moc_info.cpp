...
#include <memory>
#include "../../../../123/Bot_creator/Bot/info.h"
...
QT_MOC_LITERAL(1, 5, 10), // "infoWindow"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 15), // "on_info_clicked"
QT_MOC_LITERAL(4, 33, 14), // "mouseMoveEvent"
QT_MOC_LITERAL(5, 48, 12), // "QMouseEvent*"
QT_MOC_LITERAL(6, 61, 15), // "mousePressEvent"
QT_MOC_LITERAL(7, 77, 17), // "mouseReleaseEvent"
QT_MOC_LITERAL(8, 95, 21) // "on_pushButton_clicked"

    },
    "info\0infoWindow\0\0on_info_clicked\0"
    "mouseMoveEvent\0QMouseEvent*\0mousePressEvent\0"
    "mouseReleaseEvent\0on_pushButton_clicked"
};
...
void info::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (info::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&info::infoWindow)) {
                *result = 0;
                return;
            }
        }
