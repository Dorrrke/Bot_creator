...
" border-top-left-radius: 20px;"));
        ...
        QFont font2;
        font2.setFamily(QString::fromUtf8("Sitka Text"));
        ...
        gridLayout_10->addItem(verticalSpacer_3, 14, 0, 1, 2);
...
" border-top-left-radius: 15px;"));
        ...
        gridLayout_10->addItem(horizontalSpacer, 15, 2, 1, 1);
